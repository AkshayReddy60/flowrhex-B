...
import { MdEmail, MdPhone, MdSubject, MdMessage } from "react-icons/md";
          ...
          <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="relative">
                ...
                <input type="text" name="name" placeholder="Full Name" className="pl-10 pr-4 py-2 w-full border rounded focus:outline-none" required />
              </div>
              <div className="relative">
                <MdEmail className="absolute left-3 top-3 text-teal-500" />
                <input type="email" name="email" placeholder="Email Address" className="pl-10 pr-4 py-2 w-full border rounded focus:outline-none" required />
              </div>
              <div className="relative">
                <MdPhone className="absolute left-3 top-3 text-teal-500" />
                <input type="text" name="phone" placeholder="Phone" className="pl-10 pr-4 py-2 w-full border rounded focus:outline-none" />
              </div>
              <div className="relative">
                <MdSubject className="absolute left-3 top-3 text-teal-500" />
                <input type="text" name="subject" placeholder="Subject" className="pl-10 pr-4 py-2 w-full border rounded focus:outline-none" />
              </div>
            </div>

            <div className="relative">
              <MdMessage className="absolute left-3 top-3 text-teal-500" />
              <textarea name="message" rows="8" placeholder="Message" className="pl-10 pr-4 pt-3 w-full border rounded resize-none focus:outline-none"></textarea>
            </div>
